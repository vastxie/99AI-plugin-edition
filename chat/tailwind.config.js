      ...
      addComponents({
        ...
        '.btn-secondary': {
          ...
          '.dark &': {
            ...
            color: '#cdcdcd',
            borderColor: '#676767' /* 与悬停时的边框颜色保持一致 */,
            '&:hover:not(:disabled)': {
        ...
        '.tooltip': {
          ...
          fontWeight: '500',
          pointerEvents: 'none',
          maxWidth: '300px' /* 增加最大宽度以适应更长的英文文本 */,
          minWidth: 'max-content' /* 让短文本保持单行 */,
          textAlign: 'center',
        ...
        '.menu-items': {
          ...
          overflow: 'hidden',
          backgroundColor: '#ffffff',
          borderRadius: '0.75rem' /* 增大圆角从 0.5rem 到 0.75rem (12px) */,
