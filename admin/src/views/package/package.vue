  ...
  <div>
    ...
    <page-main style="width: 100%">
      <el-table v-loading="loading" border :data="tableData" style="width: 100%" size="large">
        ...
        <el-table-column prop="priceUsd" label="价格($)" width="100" align="center">
          <template #default="scope">
            {{ scope.row.priceUsd || '-' }}
          </template>
        </el-table-column>
    ...
    >
      ...
      >
        <el-row>
          ...
          <el-col :span="11">
            <el-form-item label="套餐价格(CNY)" prop="price">
              <el-input
          ...
          <el-col :span="11" :offset="2">
            <el-form-item label="套餐价格(USD)" prop="priceUsd">
              <el-input
                v-model.number="formPackage.priceUsd"
                placeholder="PayPal支付使用($)可选"
                type="number"
              />
            </el-form-item>
          </el-col>
